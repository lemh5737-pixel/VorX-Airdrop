...
// *** TAMBAHKAN 'push' KE IMPOR INI ***
import { getDatabase, ref, set, onValue, get, update, remove, push } from "firebase/database";
...
// *** TAMBAHKAN 'push' KE EKSPOR INI ***
export { database, ref, set, onValue, get, update, remove, push };
